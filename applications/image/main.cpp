...
lumos::ImageRGB<uint8_t> createImageFromData(const std::vector<uint8_t> &data, int width, int height)
{
  lumos::ImageRGB<uint8_t> image(height, width);
