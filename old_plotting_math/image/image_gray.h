#ifndef DUOPLOT_MATH_IMAGE_IMAGE_GRAY_H_
#define DUOPLOT_MATH_IMAGE_IMAGE_GRAY_H_
...
namespace lumos
{
    ...
    template <typename T>
    size_t ImageGray<T>::numRows() const
    {
        return num_rows_;
    }

    template <typename T>
    size_t ImageGray<T>::numCols() const
    {
        return num_cols_;
    }
