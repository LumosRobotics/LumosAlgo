...
template <typename T> size_t ImageRGB<T>::numRows() const { return num_rows_; }

template <typename T> size_t ImageRGB<T>::numCols() const { return num_cols_; }

template <typename T> T *ImageRGB<T>::data() const { return data_; }
