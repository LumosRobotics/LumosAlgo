...
template <typename T> size_t ImageGray<T>::numRows() const { return num_rows_; }

template <typename T> size_t ImageGray<T>::numCols() const { return num_cols_; }

template <typename T> size_t ImageGray<T>::numElements() const {
  return num_rows_ * num_cols_;
}

template <typename T> T *ImageGray<T>::data() const { return data_; }
