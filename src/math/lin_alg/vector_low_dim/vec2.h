...
#include "math/lin_alg/vector_low_dim/class_def/vec2.h"
...
template <typename T> T Vec2<T>::angle() const { return std::atan2(y, x); }
...
template <typename T> T Vec2<T>::squaredNorm() const { return x * x + y * y; }
