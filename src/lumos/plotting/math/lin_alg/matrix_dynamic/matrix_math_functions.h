...
#ifndef DUOPLOT_MATH_LIN_ALG_MATRIX_DYNAMIC_MATRIX_MATH_FUNCTIONS_H_
#define DUOPLOT_MATH_LIN_ALG_MATRIX_DYNAMIC_MATRIX_MATH_FUNCTIONS_H_
...
namespace duoplot
{
    ...
    {
        DUOPLOT_ASSERT((m_in.numRows() > 0) && (m_in.numCols() > 0));
    ...
    {
        DUOPLOT_ASSERT((m0.numRows() > 0) && (m0.numCols() > 0));
        DUOPLOT_ASSERT((m0.numRows() == m1.numRows()) && (m0.numCols() == m1.numCols()));
