#ifndef DUOPLOT_CONTROL_FUNCTIONS_H
...
namespace duoplot
{
    ...
    void setProperties(const ItemId id, const Us &...settings)
    {
    ...
    template <typename... Us>
    void setProperties(const std::vector<PropertySet> &property_sets)
    {
    ...
    template <typename... Us>
    void flushMultipleElements(const Us &...elements)
    {
