...
std::vector<std::string> sort(const std::vector<std::string> &strings);
void sortInPlace(std::vector<std::string> &strings);
std::vector<std::string> unique(const std::vector<std::string> &strings);

std::vector<std::string> padLeft(const std::vector<std::string> &strings, const size_t num_pad_instances, const std::string &pad_str);
std::vector<std::string> padLeftUpToTotalLength(const std::vector<std::string> &strings, const size_t total_length, const std::string &pad_str);

std::vector<std::string> padRight(const std::vector<std::string> &strings, const size_t num_pad_instances, const std::string &pad_str);
std::vector<std::string> padRightUpToTotalLength(const std::vector<std::string> &strings, const size_t total_length, const std::string &pad_str);
